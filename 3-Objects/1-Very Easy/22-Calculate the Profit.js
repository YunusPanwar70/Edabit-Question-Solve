...
function profit(obj) {
    const total = (obj.sellPrice - obj.costPrice) * obj.inventory
    return Math.round(total)
}
console.log(profit({ costPrice: 32.67, sellPrice: 45.00, inventory: 1200 }));
console.log(profit({ costPrice: 225.89, sellPrice: 550.00, inventory: 100 }));
console.log(profit({ costPrice: 2.77, sellPrice: 7.95, inventory: 8500 }));
// ➞ 14796
// ➞ 32411
// ➞ 44030
// console.log((Math.round(45.00-32.67)*1200));