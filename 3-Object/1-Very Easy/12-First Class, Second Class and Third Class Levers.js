...
function determineLever(arr) {
    if (arr[1] === "f") {
        return "first class lever"; // fulcrum in the middle
    } else if (arr[2] === "f") {
        return "second class lever"; // fulcrum on the right
    } else if (arr[0] === "f") {
        return "third class lever"; // fulcrum on the left
    } else {
        return "Invalid input"; // for any unexpected input
    }
}
